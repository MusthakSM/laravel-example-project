            ...
            <div class="md:hidden" id="mobile-menu">
                ...
                <div class="border-t border-gray-700 pb-3 pt-4">
                    <div class="flex items-center px-5">
                        ...
                        <div class="ml-3">
                            <div class="text-base font-medium leading-none text-white">Musthak Ahamed</div>
                            <div class="text-sm font-medium leading-none text-gray-400">musthakahamed741300@gmail.com</div>
                        </div>
